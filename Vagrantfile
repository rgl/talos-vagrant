...
CONFIG_TALOS_VERSION = '1.0.0-beta.1' # see https://github.com/talos-systems/talos/releases and https://www.talos.dev/docs/v1.0/introduction/support-matrix/
...
CONFIG_METALLB_CHART_VERSION = '2.6.8' # see https://artifacthub.io/packages/helm/bitnami/metallb
CONFIG_EXTERNAL_DNS_CHART_VERSION = '6.2.0' # see https://artifacthub.io/packages/helm/bitnami/external-dns
...
CONFIG_KUBERNETES_DASHBOARD_CHART_VERSION = '5.3.0' # see https://artifacthub.io/packages/helm/k8s-dashboard/kubernetes-dashboard
