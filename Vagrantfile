...
CONFIG_TALOS_VERSION = '0.14.0-alpha.1' # see https://github.com/talos-systems/talos/releases and https://www.talos.dev/docs/v0.14/introduction/support-matrix/
CONFIG_KUBERNETES_VERSION = '1.22.3' # see https://github.com/talos-systems/kubelet/releases (and https://kubernetes.io/releases/)
CONFIG_HELM_VERSION = 'v3.7.1' # see https://github.com/helm/helm/releases
CONFIG_K9S_VERSION = 'v0.25.8' # see https://github.com/derailed/k9s/releases
CONFIG_METALLB_CHART_VERSION = '2.5.11' # see https://artifacthub.io/packages/helm/bitnami/metallb
CONFIG_EXTERNAL_DNS_CHART_VERSION = '5.4.16' # see https://artifacthub.io/packages/helm/bitnami/external-dns
CONFIG_CERT_MANAGER_CHART_VERSION = '1.6.1' # see https://artifacthub.io/packages/helm/cert-manager/cert-manager
CONFIG_TRAEFIK_CHART_VERSION = '10.6.2' # see https://artifacthub.io/packages/helm/traefik/traefik
CONFIG_KUBERNETES_DASHBOARD_CHART_VERSION = '5.0.4' # see https://artifacthub.io/packages/helm/k8s-dashboard/kubernetes-dashboard
