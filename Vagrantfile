...
CONFIG_METALLB_CHART_VERSION = '2.5.7' # see https://artifacthub.io/packages/helm/bitnami/metallb
...
CONFIG_KUBERNETES_DASHBOARD_CHART_VERSION = '5.0.3' # see https://artifacthub.io/packages/helm/k8s-dashboard/kubernetes-dashboard
