...
CONFIG_EXTERNAL_DNS_CHART_VERSION = '6.7.4' # see https://artifacthub.io/packages/helm/bitnami/external-dns
...
CONFIG_KUBERNETES_DASHBOARD_CHART_VERSION = '5.7.0' # see https://artifacthub.io/packages/helm/k8s-dashboard/kubernetes-dashboard
