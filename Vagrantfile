...
CONFIG_KUBERNETES_VERSION = '1.26.5'
# see https://kubernetes.io/releases/
...
CONFIG_VECTOR_CHART_VERSION = '0.22.0'
...
CONFIG_METALLB_CHART_VERSION = '0.13.10'
...
CONFIG_EXTERNAL_DNS_CHART_VERSION = '6.20.3'

# cert-manager.
# see https://artifacthub.io/packages/helm/cert-manager/cert-manager
# renovate: datasource=helm depName=cert-manager registryUrl=https://charts.jetstack.io
CONFIG_CERT_MANAGER_CHART_VERSION = '1.12.1'
...
CONFIG_KUBERNETES_DASHBOARD_CHART_VERSION = '6.0.8'
