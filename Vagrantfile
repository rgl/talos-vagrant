...
CONFIG_TALOS_VERSION = '0.14.0-alpha.0' # see https://github.com/talos-systems/talos/releases and https://www.talos.dev/docs/v0.14/introduction/support-matrix/
CONFIG_KUBERNETES_VERSION = '1.22.2' # see https://github.com/talos-systems/kubelet/releases (and https://kubernetes.io/releases/)
CONFIG_HELM_VERSION = 'v3.7.1' # see https://github.com/helm/helm/releases
CONFIG_K9S_VERSION = 'v0.25.3' # see https://github.com/derailed/k9s/releases
...
CONFIG_TRAEFIK_CHART_VERSION = '10.6.0' # see https://artifacthub.io/packages/helm/traefik/traefik
