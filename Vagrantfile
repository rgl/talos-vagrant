...
CONFIG_TALOS_VERSION = '0.14.2' # see https://github.com/talos-systems/talos/releases and https://www.talos.dev/docs/v0.14/introduction/support-matrix/
CONFIG_KUBERNETES_VERSION = '1.23.4' # see https://github.com/talos-systems/kubelet/releases (and https://kubernetes.io/releases/)
...
CONFIG_EXTERNAL_DNS_CHART_VERSION = '6.1.8' # see https://artifacthub.io/packages/helm/bitnami/external-dns
