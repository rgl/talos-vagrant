...
talos_version="${1:-0.14.1}"; shift || true
kubernetes_version="${1:-1.23.2}"; shift || true
...
# NB kubernetes_version refers to the kublet image, e.g., ghcr.io/talos-systems/kubelet:v1.23.2
